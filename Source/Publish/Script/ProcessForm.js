...
ProcessForm.prototype = {
    Initialize: function (currentStep) {
        ...
        processForm.ItemTemplate = "<div class='card-item {2}' id='card_id_{0}' onclick='processForm.SelectCard(this);' data-card-id='{0}'>{1}</div>";
    ...
    FillDataToTextBox: function (card_info) {
        ...
        if (processForm.CurrentStep == 'verify') {
            add1 = card_info.correct_address1;
            add2 = card_info.correct_address2;
            add3 = card_info.correct_address3;
            add4 = card_info.correct_address4;
            full_address = card_info.cleaning_address;
        } else {
    ...
    SelectCard: function (card) {
        ...
        $("#ifGoogleEmbed").attr("src", "http://www.google.com.vn/custom?q=" + encodeURI(processForm.CurrentCard.cleaning_address));
    ...
    OpenGoogleSearch: function () {
        ...
        if (processForm.CurrentCard != null && processForm.CurrentCard != undefined) {
            ...
            var url = "https://www.google.com/#q=" + encodeURI(processForm.CurrentCard.cleaning_address);
